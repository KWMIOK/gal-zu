...
import { recordQuizOutcomeAction } from "@/app/actions/lessons";
import { GlassCard } from "@/components/ui/glass-card";
import type { QuizContent } from "@/types/database";
import type { FinishedCta } from "@/components/lessons/slide-deck-viewer";

/**
 * Multiple-choice quiz UI. AI / payload hints are paused for now — with
 * immediate right/wrong reveal on simple MCQs a hint adds nothing. Revisit
 * when quizzes gain harder item types (multi-step, fill-in, etc.).
 */
