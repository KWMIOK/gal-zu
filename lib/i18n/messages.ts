...
const en: Catalog = {
  ...
  "prefs.unsavedTitle": "Unsaved changes",
  "prefs.unsavedLeave":
...
const es: Catalog = {
  ...
  "prefs.unsavedTitle": "Cambios sin guardar",
  "prefs.unsavedLeave":
...
const hi: Catalog = {
  ...
  "prefs.unsavedTitle": "बिना सहेजे बदलाव",
  "prefs.unsavedLeave":
...
const ar: Catalog = {
  ...
  "prefs.unsavedTitle": "تغييرات غير محفوظة",
  "prefs.unsavedLeave":
...
const fr: Catalog = {
  ...
  "prefs.unsavedTitle": "Modifications non enregistrées",
  "prefs.unsavedLeave":
...
const pt: Catalog = {
  ...
  "prefs.unsavedTitle": "Alterações não salvas",
  "prefs.unsavedLeave":
...
const de: Catalog = {
  ...
  "prefs.unsavedTitle": "Ungespeicherte Änderungen",
  "prefs.unsavedLeave":
    "Du hast ungespeicherte Änderungen. Ohne Speichern verlassen?",
  "prefs.stay": "Bleiben",
  "prefs.leave": "Verlassen",
